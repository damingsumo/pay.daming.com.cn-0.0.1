 ...
 * @version 1.1.0
 */
class CoreApi_Wx_Order_Deal extends CoreApi {
	
	protected static $instance__; //必要,
	protected $_module = 'yd_payment';
	protected $_tableName = 'wx_order_deal_payment';
	 ...
	 * @author spring
	 */
	public function getOrderDealsByParams($params, $page = 1, $pagesize = 20, $returnType = 'Array', $orderBy = 'order_deal_payment_id') {
